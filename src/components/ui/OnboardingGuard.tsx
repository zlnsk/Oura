    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
        <div className="max-w-md w-full text-center space-y-6">
          <div className="w-16 h-16 rounded-full bg-gray-100 dark:bg-white/5 border border-[var(--border)] flex items-center justify-center mx-auto">
          ...
          <div className="space-y-3 text-left">
            {[
              ...
              <div key={step} className="flex items-start gap-3 p-3 rounded-xl bg-gray-50 dark:bg-white/[0.03]">
